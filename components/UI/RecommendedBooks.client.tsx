    ...
    <section className="mb-10 ">
      ...
      <div className="relative overflow-hidden">
        ...
        {index > 0 && (
          <button
            onClick={prev}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-slate-200 shadow rounded-full p-2"
          >
        ...
        {index < maxIndex && (
          <button
            onClick={next}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-slate-200 shadow rounded-full p-2"
          >
